...
class OrderServiceTest {
    ...
    public void 상품주문_test() throws Exception {
        // given
    ...
    public void 상품주문_재고수량초과_test() throws Exception {
        // given
        Member member = createMember();
    ...
    public void 주문취소_test() throws Exception {
        // given
        Member member = createMember();
